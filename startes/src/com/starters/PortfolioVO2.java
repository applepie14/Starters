...
public class PortfolioVO2 {
	...
	private String name;
		...
		public String toString() {
			return "portfolioVO2 [portfolioId=" + portfolioId + ", memberId=" + memberId + ", portfolioTitle="
					+ portfolioTitle + ", portfolioMethod=" + portfolioMethod + ", portfolioUrl=" + portfolioUrl
					+ ", portfolioFile=" + portfolioFile + ", portfolioText=" + portfolioText + ", uploadDate="
					+ uploadDate + ", portfolioCount=" + portfolioCount + ", likeCount=" + likeCount + ", name=" + name
					+ "]";
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			PortfolioVO2 other = (PortfolioVO2) obj;
		...
		public PortfolioVO2(){}
		public PortfolioVO2(int portfolioId, String memberId, String portfolioTitle, String portfolioMethod,
				String portfolioUrl, String portfolioFile, String portfolioText, String uploadDate, int portfolioCount,
