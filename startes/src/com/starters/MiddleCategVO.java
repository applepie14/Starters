...
public class MiddleCategVO {
	...
	public MiddleCategVO(){}

	public MiddleCategVO(int mainCategId, String mainName, int middleCategId, String middleName){
		super();
	...
	public String toString() {
		return "MiddleCategVO [mainCategId=" + mainCategId + ", mainName=" + mainName + ", middleCategId="
				+ middleCategId + ", middleName=" + middleName + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MiddleCategVO other = (MiddleCategVO) obj;
