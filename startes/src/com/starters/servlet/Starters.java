...
/*			case "companyRegisterDateStatistic":
		...
		/**관리자 공지사항 시작*/
			...
			case "adminNoticeListPaging":
				...
				page = adminCategActionPaging2(request);
				break;
			...
			case "adminNoticeListSelectAction":
				...
				page = adminCategActionSelect2(request);
				break;
		...
		/**관리자 qna 시작*/
			...
			case "adminQnaSearchAction":
				...
				page = adminQnaSearchAction2(request);
				break;
			case "adminQnaSearchPagingAction":
				page =adminQnaSearchPagingAction(request);
				page = adminQnaSearchActionPaging2(request);
				break;
				/**qna 수정*/
			case "adminQnaModify":
...
//		System.out.println("comment///"+comment);
	...
	private String adminQnaSearchActionPaging2(HttpServletRequest request) {
		dao = new MemberDAO();
		int allMembers = 0;
		HttpSession session = request.getSession();
		String id = (String)session.getAttribute("id");
	...
	private String adminQnaSearchAction2(HttpServletRequest request) {
		dao = new MemberDAO();
		int allMembers = 0;
		HttpSession session = request.getSession();
		String id = (String)session.getAttribute("id");
...
//		System.out.println("NoticeRegisterId" + NoticeRegisterId);
	...
	private String adminCategActionPaging2(HttpServletRequest request) {
		// System.out.println("admin 글쓰기 시작");
		dao = new MemberDAO();
		int adminmembers = 0;
		HttpSession session = request.getSession();
	...
	private String adminCategActionSelect2(HttpServletRequest request) {
		// System.out.println("admin 글쓰기 시작");
		dao = new MemberDAO();
		int adminmembers = 0;
		HttpSession session = request.getSession();
...
//		 System.out.println("timeCount////////"+timeCount);
	...
	private String tutoringModifyAction(HttpServletRequest request) throws IOException {
		...
		String tutoringMoney = imageUp.getParameter("tutoringMoney");
		String tutoringPlan = imageUp.getParameter("tutoringPlan");
		// System.out.println(tutoringnum+"그리고"+mainTitle+"그리고"+ subTitle+"그리고"
		// +from+"그리고"+ to+"그리고"+ daySelect1+"그리고"+
		// startTime+"그리고"+endTime+"그리고"+jobCareer+"그리고"+
		// tutoringMoney+"그리고"+tutoringPlan+"그리고"+image1 );
	...
	private String tutoringModify(HttpServletRequest request) {
		...
		// TutoringDayVO tutoringDayInfo = null;
		...
		// tutoringDayInfo = dao2.getTutoringDayInfo(num);
		// request.setAttribute("tutoringDayInfo", tutoringDayInfo);
		// System.out.println("tutoringDayInfo///////////////////"+tutoringDayInfo);
	...
	private String loginAction(HttpServletRequest request, HttpServletResponse response)
		...
		// int members2 = dao.companyCateg(id);
		// System.out.println("members"+members);
		// System.out.println("members2"+members2);

		// request.setAttribute("members2", members2);
		// System.out.println(name + "/" + id + "/" + pw + "/"+members);
		// if (name == "")
	...
	// private String nav(HttpServletRequest request) {
	// System.out.println("/////////////////내비");
	// HttpSession session = request.getSession();
	// String memberId = (String)session.getAttribute("id");
	...
	//
	// int members = dao.memberCateg2(memberId);
	// request.setAttribute("membersCateg2", members);
