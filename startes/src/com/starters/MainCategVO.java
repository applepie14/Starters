...
public class MainCategVO {
	private int mainCategId;
	private String mainName;
	
	public MainCategVO(){}
	
	public MainCategVO(int mainCategId, String mainName){
		super();
	...
	public String toString() {
		return "JobSelectVO [mainCategId=" + mainCategId + ", mainName=" + mainName + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MainCategVO other = (MainCategVO) obj;
