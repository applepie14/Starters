...
public class TutoringTuteeListVO {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TutoringTuteeListVO other = (TutoringTuteeListVO) obj;
		if (career == null) {
	...
	public String toString() {
		return "TutoringTuteeListVO [tutoringId=" + tutoringId + ", tutorId=" + tutorId + ", tuteeId=" + tuteeId
				+ ", name=" + name + ", title=" + title + ", subtitle=" + subtitle + ", startDate=" + startDate
				+ ", endDate=" + endDate + ", startTime=" + startTime + ", endTime=" + endTime + ", career=" + career
				+ ", price=" + price + ", contents=" + contents + ", count=" + count + ", uploadDate=" + uploadDate
				+ ", tutoringApplyId=" + tutoringApplyId + "]";
	}



	public TutoringTuteeListVO(int tutoringId, String tutorId, String tuteeId, String name, String title,
			String subtitle, String startDate, String endDate, String startTime, String endTime, String career,
			String price, String contents, int count, String uploadDate, int tutoringApplyId) {
		super();
		this.tutoringId = tutoringId;
		this.tutorId = tutorId;
		this.tuteeId = tuteeId;
