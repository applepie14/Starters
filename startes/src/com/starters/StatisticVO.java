...
public class StatisticVO {
	...
	public StatisticVO(String memberId, int reviewId, int tutoringApplyId, String reviewTitle, String tutoringTitle,String tutorName,String reviewContent, 
			int reviewCount, String reviewDate, int likeCount, String tutorRealName, String tuteeRealName){
		super();
	...
	public String toString() {
		return "StatisticVO [memberId=" + memberId + ", reviewId=" + reviewId + ", tutoringApplyId=" + tutoringApplyId
				...
				+ ", likeCount=" + likeCount + ", tutorRealName=" + tutorRealName + ", tuteeRealName=" + tuteeRealName
				+ "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StatisticVO other = (StatisticVO) obj;
