...
//	private String img;
	...
	public TutoringVO2(){}
	public TutoringVO2(int tutoringId, String tutorId, String title, String subtitle, String startDate, String endDate, String career,String price, String contents, int count, String uploadDate){
		super();
...
//		this.endTime = endTime;
	...
	public String toString() {
		return "TutoringVO2 [tutoringId=" + tutoringId + ", tutorId=" + tutorId + ", title=" + title + ", subtitle="
				+ subtitle + ", startDate=" + startDate + ", endDate=" + endDate + ", career=" + career + ", price="
				+ price + ", contents=" + contents + ", count=" + count + ", uploadDate=" + uploadDate + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TutoringVO2 other = (TutoringVO2) obj;
		if (career == null) {
