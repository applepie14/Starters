...
<section class="page_heading">
    <div class="row">
        <div class="holder">
            <h1>
	            <a href="starters?cmd=intro">Work hard. Dream big
		            <span class="arrow">
    ...
    <div class="row go_go normy">
        ...
        <div class="content_item right go_right">
            <div class="copy">
                ...
                <div class="content">
                    <a href="starters?cmd=registerTutee"><h2>Well begun is half done.</h2></a>
                </div>
            </div>

            <a href="starters?cmd=registerTutee" class="btn_home btn btn-icon btn-eye white">
                <span>Being Tutee</span>
                <figure>
    ...
    <svg class="eyeball" xmlns="http://www.w3.org/2000/svg" width="31" height="21" viewBox="0 0 31 21">
      <g fill="none" fill-rule="evenodd" transform="translate(2 2)">
         ...
         <ellipse cx="13.481" cy="8.5" fill="#141424" rx="2.481" ry="2.5"></ellipse>
            ...
            <div class="media">
                <figure style="background-image:url(images/home/xbarca.jpg.pagespeed.ic.2Vm7rQ1dpP3.webp)">
