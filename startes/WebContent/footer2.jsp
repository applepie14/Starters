...
<div class="footer">
	<div class="row footer_cont">
		...
		<div class="row" style="width: 100%; padding-top: 79px">
			<div class="col-9 bt_info">(주)스타터스 | 주소 : 서울특별시 성동구 살곶이길 200, 3층 
			 <br>Copyright ⓒ2018 Starters inc, ltd. All rights reserved
			 </div>
